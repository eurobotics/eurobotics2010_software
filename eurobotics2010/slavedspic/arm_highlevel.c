 ...
 *
 *  Revision : $Id: arm_highlevel.c,v 1.3 2009/05/27 20:04:07 zer0 Exp $
 *
 */
...
#define ARM_HIDE_INTER_A -135
#define ARM_HIDE_INTER_H 0

void arm_goto_hide_intermediate(void)
{
	arm_do_xy(&right_arm, ARM_HIDE_INTER_A, ARM_HIDE_INTER_H);
}

#define ARM_HIDE_FINAL_A -200
#define ARM_HIDE_FINAL_H -119

void arm_goto_hide_final(void)
{
	arm_do_xy(&right_arm, ARM_HIDE_FINAL_A, ARM_HIDE_FINAL_H);
}

#define ARM_PREPARE_A 45
#define ARM_PREPARE_H -100

void arm_goto_prepare_get_ball(void)
{
	arm_do_xy(&right_arm, ARM_PREPARE_A, ARM_PREPARE_H);
}

#define ARM_PREPARE2_A 0
#define ARM_PREPARE2_H -100

void arm_goto_prepare_get_ball2(void)
{
	arm_do_xy(&right_arm, ARM_PREPARE2_A, ARM_PREPARE2_H);
}


#define ARM_GET_INTER_A 120
#define ARM_GET_INTER_H 75

void arm_goto_get_tomato_intermediate(void)
{
	arm_do_xy(&right_arm, ARM_GET_INTER_A, ARM_GET_INTER_H);
}

#define ARM_GET_FINAL_A 135
#define ARM_GET_FINAL_H 80

void arm_goto_get_tomato_final(void)
{
	arm_do_xy(&right_arm, ARM_GET_FINAL_A, ARM_GET_FINAL_H);
}

#define ARM_UP_A 115
#define ARM_UP_H 35

void arm_goto_up_tomato(void)
{
	arm_do_xy(&right_arm, ARM_UP_A, ARM_UP_H);
}

#define ARM_PUT_INTER_A -145 //-135 	//-120
#define ARM_PUT_INTER_H 0 		//35

void arm_goto_put_ball_intermediate(void)
{
	arm_do_xy(&right_arm, ARM_PUT_INTER_A, ARM_PUT_INTER_H);
}

#define ARM_PUT_INTER2_A -165 //-135 	//-120
#define ARM_PUT_INTER2_H -40 		//35

void arm_goto_put_ball_intermediate2(void)
{
	arm_do_xy(&right_arm, ARM_PUT_INTER2_A, ARM_PUT_INTER2_H);
}

#define ARM_PUT_FINAL_A -175
#define ARM_PUT_FINAL_H -80

void arm_goto_put_ball_final(void)
{
	arm_do_xy(&right_arm, ARM_PUT_FINAL_A, ARM_PUT_FINAL_H);
}

#define ARM_HOLD_LAST_A -120 	//-120
#define ARM_HOLD_LAST_H 20 		//35

void arm_goto_hold_last_ball(void)
{
	arm_do_xy(&right_arm, ARM_HOLD_LAST_A, ARM_HOLD_LAST_H);
}

#define ARM_GET_SMALL_A	0
#define ARM_GET_SMALL_H 0

void arm_goto_get_orange_small(void)
{
	arm_do_xy(&right_arm, ARM_GET_SMALL_A, ARM_GET_SMALL_H);
}

#define ARM_GET_MED_A 0
#define ARM_GET_MED_H 0

void arm_goto_get_orange_medium(void)
{
	arm_do_xy(&right_arm, ARM_GET_MED_A, ARM_GET_MED_H);
}

#define ARM_GET_TALL_A 0
#define ARM_GET_TALL_H 0

void arm_goto_get_orange_tall(void)
{
	arm_do_xy(&right_arm, ARM_GET_TALL_A, ARM_GET_TALL_H);
}
...
//#define ARM_PUSH_TEMPLE_H -135
//
//void arm_goto_push_temple(uint8_t arm_num)
//{
//	struct arm *arm = arm_num2ptr(arm_num);
//	arm_do_xy(arm, ARM_PUSH_TEMPLE_D, ARM_PUSH_TEMPLE_H, WRIST_ANGLE_PUMP1);
//}
//
//#define ARM_PREPARE_PUSH_TEMPLE_D 100
//#define ARM_PREPARE_PUSH_TEMPLE_H -80
//
...
//}
//
//#define ARM_PUSH_TEMPLE_DISC_D1 205
//#define ARM_PUSH_TEMPLE_DISC_H1 -100
//#define ARM_PUSH_TEMPLE_DISC_D2 180
