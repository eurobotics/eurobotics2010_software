...
static struct sensor_filter sensor_filter[SENSOR_MAX] = {
	[S_VACUUM] 			= { 1, 0, 0, 1, 0, 1 }, /* 0 */
	[S_L_BALL_IN] 	= { 1, 0, 0, 1, 0, 1 }, /* 1 */
	[S_RESERVED0] 	= { 1, 0, 0, 1, 0, 1 }, /* 2 */
	[S_SUCKER_OBJ] 	= { 1, 0, 0, 1, 0, 1 }, /* 3 */
	[S_CORN_INSIDE]	= { 1, 0, 0, 1, 0, 0 }, /* 4 */
	[S_CORN_INSIDE_EXTRA]	= { 1, 0, 0, 1, 0, 1 }, /* 5 */
	[S_RESERVED1] 	= { 1, 0, 0, 1, 0, 0 }, /* 6 */
	[S_RESERVED2] 	= { 1, 0, 0, 1, 0, 0 }, /* 7 */
	[S_RESERVED3] 	= { 1, 0, 0, 1, 0, 0 }, /* 8 */
	[S_RESERVED4] 	= { 1, 0, 0, 1, 0, 0 }, /* 9 */
	[S_RESERVED5]	 	= { 1, 0, 0, 1, 0, 0 }, /* 10 */
	[S_RESERVED6] 	= { 1, 0, 0, 1, 0, 0 }, /* 11 */
	[S_RESERVED7] 	= { 1, 0, 0, 1, 0, 0 }, /* 12 */
	[S_RESERVED8] 	= { 1, 0, 0, 1, 0, 0 }, /* 13 */
	[S_RESERVED9] 	= { 1, 0, 0, 1, 0, 0 }, /* 14 */
	[S_RESERVED10] 	= { 1, 0, 0, 1, 0, 0 }, /* 15 */
};
...
/* sensor mapping : 
 * RA: S_VACCUM(8)
 * RB: S_R_BALL_IN(11), S_L_BALL_IN(10)
 * RC: S_CORN_INSIDE(2), S_SUCKER_OBJ(3)
 * RB: S_ARM_FC(4)
 */
...
{
	uint16_t tmp = 0;
	tmp |= (uint16_t)((PORTA & (_BV(8)))>> 8)<< 0;
	tmp |= (uint16_t)((PORTB & (_BV(11)|_BV(10)))>> 10)<< 1;
	tmp |= (uint16_t)((PORTC & (_BV(3)))>> 3)<< 3;
	tmp |= (uint16_t)((PORTB & (_BV(4)))>> 4)<< 4;
